  ...
  return (
    <div>
        <form className='form_type_game'>
            ...
            <div id='gt_gmail'>
                <p className='p'>Moonton Account or Username :</p>
                <input value={username} onChange={e=>setusername(e.target.value)} className='coc_ip' type='text' placeholder='Username...'/>

                <p className='p'>Password :</p>
                <input value={password} onChange={e=>setpassword(e.target.value)} className='coc_ip' type='password' placeholder='Password...'/>
            </div>
